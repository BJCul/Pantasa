...
if __name__ == "__main__":
    ...
    input_txt_path = 'data/raw/piptylines.txt'  # Replace with your erroneous sentences text file path
    output_csv_path = 'data/raw/erroneous_dataset.csv'    # Desired output CSV file path for erroneous data
    ...
    results_output_csv = 'data/processed/erroneous_output_result.csv'
