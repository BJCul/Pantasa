...
def evaluate_correction(results_csv):
    ...
    - TP: The model corrected the sentence, and the correction done was correct.
    - FP: The model corrected the sentence, but the correction was wrong or unnecessary.
    - FN: The model did not correct the sentence, but the data needed correction.
    - TN: The model did not correct the sentence, and the data didn’t need correction.
